...
contract Main is BEP20, SharedOwnable, SafeToken {
    ...
    uint256 private _token1DividendRewardsFee = 3;
    uint256 private _Wallet2WalletFee = 0; // no wallet to wallet fee
    uint256 private _BuyFee = 11;
    ...
    constructor(string memory name_, string memory symbol_, uint8 decimal_, address reward1_, address marketing_, address team_, address multiuse_, uint256 supply_, uint256 dispatch_, uint8 maxtaxes_) BEP20(name_, symbol_) {
        ...
        dividendTracker1 = new DIVIDENDTracker1("ProBets_Track", "PBTT", Token1Adress, minTokenBalanceForDividends, decimal, Creator);
...
contract ProBets is Main {
    ...
    constructor() Main (
        ...
        0x781B24e00DFE58Eb1754E9B1793cc6c810F9Df75,     // Marketing address
        0xdACdFCc695b115B3d3929b293b98ffC3aBfa738C,     // Team address
        0xa8D2DEC383313c0d3B354934E7c3e486b96FE976,     // Multi Use address
        10_000_000,      // Initial Supply
        10_000_000,       // Dispatch Supply
        15     // Max Tax
        ) {} 
	  ...
	  // DarthmOOn Prod 0xef6f9Fc9A499005b8b834E2180513D6231c47658
	  ...
	  // DarthmOOn Test 0xe7C1609D5A7e910e0503B34c8CACB8C0cF7Be328
