...
contract HelenaFinancial is ERC20Detailed, Ownable {
    ...
    string public _name = "Helena Financial";
    string public _symbol = "HELENA";
    ...
    constructor() ERC20Detailed("Helena Financial", "HELENA", uint8(DECIMALS)) Ownable() {
