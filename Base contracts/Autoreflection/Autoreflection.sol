...
contract AutoReflection is BEP20, Ownable, SafeToken {
    using SafeMath for uint256;
    ...
    constructor() BEP20("AUTO REFLECTION", "ART") {
    ...
    function setContractLimits(uint256 _maxWallet, uint256 _maxSell, uint256 MaxTax, bool _swapAndLiquifyEnabled) public onlyOwner {
