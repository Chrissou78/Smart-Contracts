...
contract MWStandardToken is Context, IERC20, Ownable {
    ...
    constructor (address MWWallet,uint8 decimals_, uint256 supply, string memory name_, string memory symbol_, uint256 Maxs, uint256 initialTax, uint256 Tax, uint256 CyclesReduce, uint256 SwapBefore ) {
