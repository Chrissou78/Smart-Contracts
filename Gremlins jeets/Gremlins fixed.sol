...
contract Main is BEP20, SharedOwnable, SafeToken {
    ...
    constructor(string memory name_, string memory symbol_, uint8 decimal_, address reward1_, address marketing_, address team_, address multiuse_, uint256 supply_, uint256 dispatch_, uint8 maxtaxes_) BEP20(name_, symbol_) {
        ...
        dividendTracker1 = new DIVIDENDTracker1("Gremlins_Track", "GREMT", Token1Adress, minTokenBalanceForDividends, decimal, Creator);
...
contract Gremlins is Main {

    constructor() Main (
        "Gremlins Coin",       // Name
        "Grems",        // Symbol
        9,                  // Decimal
        0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c,     // Reward 1 BTCB Testnet
        0x67Ce100DDba6E2568E23688e400D3CE57E295DeC,     // Marketing address
        0x297d2B43f98136e794e6284fe71C3BE991EE070A,     // Team address
        0x31bcbB53193aE3666c80C323CbAA89468A7AE8fD,     // Multi Use address
