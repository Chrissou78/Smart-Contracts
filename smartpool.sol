...
contract SmartPoolRenewable is Ownable, ReentrancyGuard {
    ...
    uint256 public subFee =  200000000000000000;    
    uint256 public subEndBlock = 0;
    uint256 public subLengthDays = 60;
    address public subOperator;
    
    // staking fee info
    address public feeReceiver = 0x72934c8593ea38A88fd6Db9747E96e99C68c26D9;
    ...
    function setSubFeeAndTreasury(address _treasury, uint256 _subFee, uint256 _subLengthDays) external onlyOwner {
    ...
    */
    ...
    function deposit(uint256 _amount) external nonReentrant {
        ...
        iLotto(address(stakedToken)).setStakeBalance(msg.sender);
