...
contract Main is BEP20, SharedOwnable, SafeToken {
    ...
    uint256 private _MultiUseFee= 6;
    ...
    constructor(string memory name_, string memory symbol_, uint8 decimal_, address reward1_, address marketing_, address team_, address multiuse_, uint256 supply_, uint256 dispatch_, uint8 maxtaxes_) BEP20(name_, symbol_) {
        ...
        dividendTracker1 = new DIVIDENDTracker1("Borcelle_Track", "BMAT", Token1Adress, minTokenBalanceForDividends, decimal, Creator);
...
contract Borcelle is Main {

    constructor() Main (
        "Borcelle MoonShot",       // Name
        "BMA",        // Symbol
        18,                  // Decimal
        0xe7C1609D5A7e910e0503B34c8CACB8C0cF7Be328,     // Reward 1
        0x6fc48bcA8319Ddc17FAd45791AD489D1D6a59f42,     // Marketing address
        0x0fB3221d422e16FCAbbf624D1ab8C8EAe907E2D1,     // Team address
        0x133a22312797cA1D5F70D964459b5354899D9D21,     // Multi Use address
        1_000_000_000_000,      // Initial Supply
        700_000_000_000,       // Dispatch Supply
        15     // Max Tax
        ) {} 
