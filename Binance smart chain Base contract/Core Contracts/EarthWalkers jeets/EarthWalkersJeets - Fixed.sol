...
contract Main is BEP20, SharedOwnable, SafeToken {
    ...
    uint256 private _token1DividendRewardsFee = 5;
    uint256 private _token2DividendRewardsFee = 2;
    ...
    constructor(string memory name_, string memory symbol_, uint256 decimal_, address reward1_, address reward2_, address marketing_, address team_, address multiuse_, uint256 supply_, uint256 dispatch_) BEP20(name_, symbol_) {
        ...
        dividendTracker1 = new DIVIDENDTracker1("EarthWalk1_T", "EWT1", Token1Adress, minTokenBalanceForDividends, decimal, Creator);
    	dividendTracker2 = new DIVIDENDTracker2("EarthWalk2_T", "EWT2", Token2Adress, minTokenBalanceForDividends, decimal, Creator);
...
contract EarthWalkers is Main {
    ...
    constructor() Main (
        ...
        0x9e566A4A22dCAfeF7De5d829Fd199d297Bb01487,     // Reward 2
