...
contract Main is BEP20, SharedOwnable, SafeToken {
    ...
    constructor(string memory name_, string memory symbol_, uint8 decimal_, address marketing_, address team_, address multiuse_, uint256 supply_, uint256 dispatch_, uint8 maxtaxes_) BEP20(name_, symbol_) {
        ...
        dividendTracker = new MoonWalkersDividendTracker("Reward1_Div_Track", "RDT1", minTokenBalanceForDividends, decimal);
...
contract SingleRewardBNB is Main {

    constructor() Main (
        "Single Reward BNB",       // Name
        "SRTBNB",        // Symbol
        9,                  // Decimal
        ...
        10000000000,      // Initial Supply
        2000000000,       // Dispa&tch Supply
        25     // Max Tax
        ) {} 
}
