...
contract Main is BEP20, SharedOwnable, SafeToken {
    ...
    constructor(string memory name_, string memory symbol_, uint8 decimal_, address reward1_, address marketing_, address team_, address multiuse_, uint256 supply_, uint256 dispatch_, uint8 maxtaxes_) BEP20(name_, symbol_) {
        ...
        StakingWallet = payable(msg.sender);
        ...
        dividendTracker1 = new DIVIDENDTracker1("Panda_Track", "PandaT", Token1Adress, minTokenBalanceForDividends, decimal, Creator);
    ...
    function GetContractBalance() external view returns (uint256 marketingbnb, uint256 teambnb , uint256 multiusebnb) {return(marketingBNBPortion, teamBNBPortion , multiuseBNBPortion);}
    ...
    function SetJeetsTax(bool jeetsfee, bool jeetsburn, uint8 vmindiv, uint8 vmaxdiv, uint8 maxjeetsfee)  external onlySharedOwners {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private {
        ...
        uint256 stakingPortion = contractTokenBalance * _StakingFee / TotalFees;
...
contract PandaAge is Main {
    ...
    constructor() Main (
        ...
        0x4A074Dcd1eB443Cf1561900C167d4BDBE6243697,     // Marketing address
        0x2Db96c4F203fBc13c98bBa428ba9E09B48543b0A,     // Team address
        0x2Db96c4F203fBc13c98bBa428ba9E09B48543b0A,     // Multi Use address
        1_000_000_000,      // Initial Supply
        1_000_000_000,       // Dispa&tch Supply
        20     // Max Tax
        ) {} 
}
