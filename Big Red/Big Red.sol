...
contract BigRed is Context, IERC20, Ownable {
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFromFee;
    address payable private _taxWallet;
    address public Router = 0x60aE616a2155Ee3d9A68541Ba4544862310933d4; //0x60aE616a2155Ee3d9A68541Ba4544862310933d4 P //0xd7f655E3376cE2D7A2b08fF01Eb3B1023191A901 T
    ...
    string private _name = unicode"Big Red";
    string private _symbol = unicode"$Td";
